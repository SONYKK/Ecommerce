...
const AboutPage = () => {
    ...
    return (
        <Page>
            ...
            <p>
                {t('Компания «Rodonit» рада приветствовать Вас на сайте нашего интернет магазина. '
                ...
                + 'партнерские отношения и стараемся найти индивидуальный подход к каждому клиенту. ')}
            </p>
