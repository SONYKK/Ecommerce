...
export var LangSwitcher = function (_a) {
    ...
    return (_jsx("div", __assign({ className: classNames('', {}, [className]) }, { children: _jsx(Button, __assign({ theme: ButtonTheme.CLEAR, onClick: toggle }, { children: t('Язык') }), void 0) }), void 0));
};
