...
export var addCommentForArticle = createAsyncThunk('articleDetails/addCommentForArticle', function (text, thunkApi) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                userData = getUserAuthData(getState());
                article = getArticleDetailsData(getState());
